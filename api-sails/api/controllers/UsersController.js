...
module.exports = {
    ...
    post: async function(req, res){
        ...
        if(!params.nombre)
            ...
            //los procesos a bd es asincrono y hay que esperarlo con await

            /*El fetch tien dos porositos, traer y actualizar y el segundo es respetar el ciclo de vida
            de un registro
    ...
    put: async function(req, res){
        ...
        var resUsers = await Users.update({id:id}).fetch();
        return res.ok(resUsers);
    },
